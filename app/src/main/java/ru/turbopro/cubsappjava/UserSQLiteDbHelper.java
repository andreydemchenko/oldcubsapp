...
public class SQLiteDbHelper extends SQLiteOpenHelper {
    ...
    public Cursor readAll() {
        ...
        Cursor cursor = null;
        try {
            cursor = mdb.query(TABLE_NAME, new String[] {ID, FULL_NAME, LOGIN, ACHIEVEMENTS, ALL_POINTS, POINTS, HOURS, IMAGE_URL},
            ...
            while (cursor.moveToNext()) {
                ...
                Log.d("mLog", "Запись(id): " + id + "    name: " + name + " " +
                        "   login: " + login+"   achievements: " + achievements + "   all_points: " + all_points+"  points: "+points + "   hours: " +hours+"  image_url: " + image_url);
            }
    ...
    public void insert(String name, String login, int points, int all_points, int hours, String user_image_URL, ArrayList<String> achiv_progress) {
        ...
        value.put(IMAGE_URL, user_image_URL);
